...
SET @new_email_reg = RequestParameter('email_Id')
      ...
      UpsertDE("DE_MASTER_AMOVIG","AABP_DCF_Doctor_Code", @decrypt_dcf,"Login_id", @new_email_reg,"First_name", @FirstName,"Amgen_id", @Amgen_id,"Account_id", @Account_id,"TokenStatus", @TokenStatus)
 
      else
         
      UpsertDE("DE_MASTER_AMOVIG","AABP_DCF_Doctor_Code", @decrypt_dcf,"Login_id", @EmailAddress,"First_name", @FirstName,"Amgen_id", @Amgen_id,"Account_id", @Account_id,"TokenStatus", @TokenStatus) 
      endif
  ...
  <style>
    * {
    ...
    button {
      ...
      outline: 0;
      border: none;
      background: url('https://image.amgenmail.com/lib/fe301171716404747c1770/m/1/b9e5ec46-e6a1-44c5-a753-ced15885c085.png') #7b024d center right no-repeat;
...
<body>
  <div class="banner">
    <img src="https://image.amgenmail.com/lib/fe301171716404747c1770/m/1/88a83dcb-6c23-485c-840a-270240c35aa4.png"
      alt="logo" class="logo">
  </div>
  <div class="bg-color">
    <div class="banner-img">
      <img src="https://image.amgenmail.com/lib/fe301171716404747c1770/m/1/0222cc5e-db9f-48d2-836a-cfc349f82607.jpg"
        alt="banner">
    </div>
  </div>
  <div class="wrapper">
    <form action="%%=RequestParameter('PAGEURL')=%%" method="post" name="registration" accept-charset="utf-8"
      ...
      <ol class="order-list contains-other">
        <li>
          <p>NEXTに許諾いただいた以下のメールアドレスで、<br>
            アイモビーグ.jpに会員登録してよろしいですか？</p>
          <ul class="unorder-list unorder-radio">
            <li>
              <label for="Register_member_email_address" class="register1">
                <input type="radio" name="select_info" checked='true' value="Register_member_email_address"
                  id="Register_member_email_address" data-text="others-text-1" />
                このメールアドレスで会員登録する
              </label>
            </li>
            ...
            <li>
              <label for="Register_member_another_emailaddress" id="register">
                <input type="radio" rows="1" name="select_info" value="Register_member_another_emailaddress"
                  id="Register_member_another_emailaddress" data-text="others-text-1" />
                他のメールアドレスで会員登録する
              </label>
            </li>
            <div class="sub-list">
              <ul class="unorder">
                ...
                <li>
                  ...
                  <div id="confirmEmailErrorMsg2">
                  </div>
                </li>
              </ul>
            </div>
            <div id="confirmEmailErrorMsg">
            </div>
            <li>
              <label for="not_register_member" class="register1">
                <input type="radio" name="select_info" value="not_register_member" id="not_register_member"
                  class="radio-other" data-text="others-text-1" />
                会員登録しない
              </label>
            </li>
          </ul>
    ...
    <div class="footer-flex">
      ...
      <div class="left-flex">
        <img src="https://image.amgenmail.com/lib/fe301171716404747c1770/m/1/3e23e3ae-0f40-4195-bb63-ed7916d1ee2e.jpg"
          alt="Amgen logo">
      </div>
    </div>
  </div>
...
<script>
  ...
  $(document).ready(function () {
    function validateFields() {
      ...
      errorMsgDiv.html('');
      errorMsgDiv.hide();
      var chkBoxErrorMsg = $('#checkBoxErrorMsg');
      chkBoxErrorMsg.html('');
      chkBoxErrorMsg.hide();
     ...
     if (emailId.val() == '' || !emailRegEx.test(String(emailId.val()).toLowerCase())) {
        emailId.css("border", "1px solid red");
        errorMsgDiv1.empty().append("<span class='label label-important'>メールアドレスを入力してください</span>");
        errorMsgDiv.show();
        result = false;
      }

      if (confirmEmailId.val() == '') {
        confirmEmailId.css("border", "1px solid red");
        errorMsgDiv2.empty().append("<span class='label label-important'>メールアドレスを入力してください</span>");
        errorMsgDiv.show();
        result = false;
      }
      else if (confirmEmailId.val() !== emailId.val()) {
        confirmEmailId.css("border", "1px solid red");
        errorMsgDiv.append("<span class='label label-important'> 有効なメールアドレスを入力してください </span>");
