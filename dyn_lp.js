...
<script runat=server>  
    ...
    for (var i = 0; i < e_DE.length; i++)
    {
       ...
       var Insert_data = Platform.Function.IpsertData('Decryoted_data_Test', ['Email', 'FirstName', 'LastName'],[E_Email, E_FN, E_LN]);
       var update_data = Platform.Function.UpdateData('Decryoted_data_Test', ['Email', 'FirstName', 'LastName'],[E_Email, E_FN, 'test1']);
