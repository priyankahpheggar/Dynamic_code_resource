...
SET @newDCF_reg = RequestParameter('newDCF_reg')
      ...
      InsertDE("DE_MASTER_AMOVIG","AABP_DCF_Doctor_Code", @decrypt_dcf,"Login_id", @newDCF_reg,"First_name", @FirstName,"Amgen_id", @Amgen_id,"Account_id", @Account_id,"TokenStatus", @TokenStatus)
